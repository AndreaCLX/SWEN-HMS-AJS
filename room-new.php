			...
			<div class="main-content">
				...
				<div class="card">
					...
					<div class="card-main-content">
						<form action="room-insert.php" method="POST" class="BookingForm">
							<div class="material-input material-input-floating-lbl required-field" data-validator-error="Room Type is a Required Field!">
								<input type="text" name="RoomType" />
								<label class="placeholder">Room Type</label>
							</div>
							
							<div class="material-input material-input-floating-lbl required-field" data-validator-error="Room Location is a Required Field!">
								<input type="text" name="RoomLocation" />
								<label class="placeholder">Room Location</label>
							</div>
							
							<div class="material-input material-input-floating-lbl required-field" data-validator-error="Room Rate is a Required Field!">
								<input type="text" class="number-only" name="RoomRate" />
