	...
	<body>
		<div class="main-container">
			...
			<div class="main-content">
				...
				$query = mysqli_query($db,"SELECT * FROM `staff` WHERE `StaffID` = '$StaffID'");
				...
				<div class="page-content">
					...
					<div class="card" >
						...
						<div class="card-main-content">
							...
							<form action="staff-update.php?StaffID=<?php echo $StaffID; ?>" method="POST" class="BookingForm">
								<div class="material-input material-input-floating-lbl material-input-floating-lbl-active required-field" data-validator-error="Name is a Required Field!">
									<input type="text" name="Name" value="<?php echo $s['Username']; ?>"/>
									<label class="placeholder" >Name</label>
								</div>
								
								<div class="material-input material-input-floating-lbl material-input-floating-lbl-active required-field" data-validator-error="Email is a Required Field!">
									<input type="text" name="Email" value="<?php echo $s['Email']; ?>"/>
									<label class="placeholder">Email</label>
								</div>
								
								<div class="material-input material-input-floating-lbl material-input-floating-lbl-active required-field" data-validator-error="Phone Number is a Required Field!">
									<input type="text" name="PhoneNumber" class="number-only" value="<?php echo $s['PhoneNumber']; ?>"/>
									<label class="placeholder">Phone Number</label>
								</div>
								
								<div class="material-input material-input-floating-lbl material-input-floating-lbl-active required-field" data-validator-error="Bank Account is a Required Field!">
									<input type="text" name="BankAccount" value="<?php echo $s['BankAccount']; ?>"/>
									<label class="placeholder">Bank Account</label>
								</div>
								
								<div class="material-input required-field material-input-floating-lbl-active required-field" data-validator-error="Room Location is a Required Field!">
									<label class="placeholder-fixed">Address</label>
									<textarea class="autogrow" name="Address"><?php echo $s['Address']; ?></textarea>
								</div>
								...
								<div class="material-input material-input-floating-lbl required-field material-input-floating-lbl-active" data-validator-error="Postal Code is a Required Field!">
									<input type="text" name="PostalCode" value="<?php echo $s['PostalCode']; ?>"/>
					...
					<div class="form-submit-menu">
						<input type="button" onClick="validateForm('.BookingForm');" value="Update Staff" class="btn btn-square btn-success">
					</div>
