		...
		<div class="main-container">
			...
			<div class="main-content">
				...
				<?php 
					...
					$query = "UPDATE `booking` SET `BedType` = '$BedType', `SmokingRoom` = '$SmokingRoom', `AdditionalGuests` = '$AddtionalGuestCompiled', `PaymentMethod` = '$PaymentMethod', `PaymentAdditionalInfo` = '$PaymentAdditionalInfo', `CheckInDate` = '$CheckInDate', `CheckOutDate` = '$CheckOutDate', `CheckOutTime` = '$LateCheckOutTime' WHERE `BookingID` = '$BookingID'";
